...
public class PrepareTop implements Prepare {
	...
	public void execute(User user, App app) {
		packet.send(user, "{\"INCOME\":{\"x\":266,\"y\":89.8,\"z\":-270,\"yaw\":-135,\"title\":\"Топ по доходу\"},\"EXPERIENCE\":{\"x\":261,\"y\":89.8,\"z\":-278,\"yaw\":-90,\"title\":\"Топ по опыту\"},\"MONEY\":{\"x\":266,\"y\":89.8,\"z\":-286,\"yaw\":-45,\"title\":\"Топ по деньгам\"}}");
	}
}
