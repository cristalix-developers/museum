...
public class MuseumCommands {
    ...
    private final List<Button> menuButtons = new ArrayList<>(Arrays.asList(
            ...
            new Button(
                    "minecraft:textures/items/compass.png",
                    -1,
                    "§bЭкспедиции",
            ...
            new Button(
                    "minecraft:textures/other/new_lvl_rare_close.png",
                    -1,
                    "§bЛутбокс",
    ...
    private final List<Button> polishingButton = new ArrayList<>(Collections.singletonList(
            new Button(
                    "minecraft:textures/other/anvil.png",
                    PRICE,
                    "§bЮвелир",
                    "§7Вы можете поменять\n" +
                ...
                val user = App.getApp().getUser(click);
                val itemInHand = click.getItemInHand();
                val tag = CraftItemStack.asNMSCopy(itemInHand).tag;
                Gem gem = null;
    ...
    private final List<Button> donateButtons = new ArrayList<>(Arrays.asList(
            ...
            new Button(
                    "minecraft:mcpatcher/cit/others/hub/iconpack/win2.png",
                    79,
            ...
            new Button(
                    "minecraft:textures/prison/shoveld.png",
                    349,
            ...
            new Button(
                    "minecraft:textures/museum/porovoz.png",
                    249,
