/*
* ВНИМАНИЕ!
* Этот файл собирается с другими в один, осторожнее с именами переменных
* Данный скрипт не находится в .jar! Папка со скриптаме на сервере scripts/
*  */
...
PluginMessages.on(self, 'museum', function (bb) {
    const n = UtilNetty.readVarInt(bb) - 1;
